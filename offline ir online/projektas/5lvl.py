...
#ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\garfield\Desktop\projektas\level1_image")
...
def play_music(window):
    pygame.mixer.init()
    #pygame.mixer.music.load(r"C:\Users\garfield\Desktop\projektas\music2.mp3")
...
entry_6.insert(0, "9")
entry_6.configure(state='readonly')
...
entry_13.insert(0, "6")
entry_13.configure(state='readonly')
...
entry_16.insert(0, "9")
entry_16.configure(state='readonly')
...
entry_26.insert(0, "6")
entry_26.configure(state='readonly')
...
entry_28.insert(0, "8")
entry_28.configure(state='readonly')
...
entry_30.insert(0, "9")
entry_30.configure(state='readonly')
...
entry_36.insert(0, "7")
entry_36.configure(state='readonly')
...
entry_46.insert(0, "7")
entry_46.configure(state='readonly')
...
entry_48.insert(0, "5")
entry_48.configure(state='readonly')
...
entry_54.insert(0, "2")
entry_54.configure(state='readonly')
...
entry_58.insert(0, "3")
entry_58.configure(state='readonly')
...
entry_65.insert(0, "1")
entry_65.configure(state='readonly')
...
entry_69.insert(0, "6")
entry_69.configure(state='readonly')
...
entry_70.insert(0, "3")
entry_70.configure(state='readonly')
...
entry_76.insert(0, "9")
entry_76.configure(state='readonly')
...
entry_82.insert(0, "7")
entry_82.configure(state='readonly')

canvas.create_text(
    924.0,
    77.0 + 50,
    anchor="nw",
    text="Laimėk sviestuką!",
    fill="#FFFFFF",
    font=("Inter ExtraBold", 64 * -1)
)

image_image_2 = PhotoImage(
    file=relative_to_assets("ponas.png"))
...
def win():
    ...
    if (x == 45):
        messagebox.showinfo("Information", "Sveikiname gavus sviestą bei"+ test+' tasku!')
        title()
        
    else:
        messagebox.showwarning("Warning", "Dėja sviesto nebus "+test + ' ,nes tiek tasku')
