...
entry_8.insert(0, '6')
entry_8.configure(state='readonly')
...
entry_10.insert(0, '9')
entry_10.configure(state='readonly')
...
entry_19.insert(0, '2')
entry_19.configure(state='readonly')
...
entry_40.insert(0, '5')
entry_40.configure(state='readonly')
...
entry_42.insert(0, '7')
entry_42.configure(state='readonly')
...
entry_63.insert(0, '1')
entry_63.configure(state='readonly')
...
entry_72.insert(0, '2')
entry_72.configure(state='readonly')
...
entry_74.insert(0, '9')
entry_74.configure(state='readonly')
...
image_image_2 = PhotoImage(
    file=relative_to_assets("skalbimas.png"))
...
def win():
    ...
    record = x
    mycursor.execute("UPDATE Sudoku set level4 = %s", (record,))
    db.commit()
        
    if (record == 45):
        messagebox.showinfo("Information", "Sveikiname gavus jį bei"+ str(record) +' tasku!')
        title()
        
    else:
        messagebox.showwarning("Warning", "Dėja jo nebus "+ str(record) + ' ,nes tiek tasku')
