...
entry_5.insert(0, '4')
entry_5.configure(state='readonly')
...
entry_9.insert(0, '3')
entry_9.configure(state='readonly')
...
entry_18.insert(0, '1')
entry_18.configure(state='readonly')
...
entry_33.insert(0, '7')
entry_33.configure(state='readonly')
...
entry_47.insert(0, '8')
entry_47.configure(state='readonly')
...
entry_64.insert(0, '9')
entry_64.configure(state='readonly')
...
entry_67.insert(0, '1')
entry_67.configure(state='readonly')
...
entry_68.insert(0, '8')
entry_68.configure(state='readonly')
...
entry_73.insert(0, '2')
entry_73.configure(state='readonly')
...
entry_79.insert(0, '3')
entry_79.configure(state='readonly')
...
entry_81.insert(0, '1')
entry_81.configure(state='readonly')
...
canvas.create_text(
    ...
    77.0 + 50,
    anchor="nw",
    text="Laimėk arbatinuką!",
    fill="#FFFFFF",
    font=("Inter ExtraBold", 64 * -1)
)

image_image_2 = PhotoImage(
    file=relative_to_assets("teapod.png"))
...
def win():
    ...
    record = x
    mycursor.execute("UPDATE Sudoku set level2 = %s", (record,))
    db.commit()
    
    if (record == 45):
        messagebox.showinfo("Information", "Sveikiname gavus arbatinuką bei "+ str(record) +' tasku!')
        title()
        
    else:
        messagebox.showwarning("Warning", "Dėja arbatinuko nebus "+ str(record) + ' ,nes tiek tasku')
