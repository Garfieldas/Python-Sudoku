...
entry_35.insert(0, '2')
entry_35.configure(state='readonly')
...
entry_37.insert(0, '3')
entry_37.configure(state='readonly')
...
entry_41.insert(0, '4')
entry_41.configure(state='readonly')
...
entry_45.insert(0, '2')
entry_45.configure(state='readonly')
...
entry_49.insert(0, '3')
entry_49.configure(state='readonly')
...
image_image_2 = PhotoImage(
    file=relative_to_assets("henris.png"))
...
def win():
    ...
    record = x
    mycursor.execute("UPDATE Sudoku set level3 = %s", (record,))
    db.commit()
          
    if (record == 46):
        messagebox.showinfo("Information", "Sveikiname gavus liurbį bei "+ str(record) +' tasku!')
        title()
        
    else:
        messagebox.showwarning("Warning", "Dėja liurbio nebus "+ str(record) + ' ,nes tiek tasku')
